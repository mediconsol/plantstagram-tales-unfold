  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <Header />
        <main className="flex-1 container mx-auto desktop-container section-spacing pt-16 md:pt-20">
  ...
  if (error || !post) {
    return (
      <div className="min-h-screen bg-background flex flex-col">
        <SEOHead {...seoProps} />
        <Header />
        <main className="flex-1 container mx-auto desktop-container section-spacing pt-16 md:pt-20 max-w-2xl">
          <div className="mb-6">
            <Button
              variant="ghost"
